...
VALUES
    ...
    ('LOA',                'Letter of Appointment', 'Letter of Appointment',
     'Signed letter appointing the LEW to act on your behalf',
     'Upload the signed Letter of Appointment. PDF, JPG, or PNG accepted.',
