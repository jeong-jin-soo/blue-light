...
export default function PowerSocketManagerDashboardPage() {
  ...
  const goOrders = (q: string) =>
    navigate(q ? `/power-socket-manager/orders?status=${q}` : '/power-socket-manager/orders');

  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <PageHeader title="Power Socket Manager Dashboard" subtitle="Overview of Power Socket orders" />
