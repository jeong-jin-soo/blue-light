...
export default function LewServiceManagerDashboardPage() {
  ...
  const goOrders = (q: string) =>
    navigate(q ? `/lew-service-manager/orders?status=${q}` : '/lew-service-manager/orders');

  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <PageHeader title="LEW Service Manager Dashboard" subtitle="Overview of LEW Service orders" />
